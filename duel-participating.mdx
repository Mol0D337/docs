---
title: "GET /duel/participating"
---

**URL:** https://xapi.duelduck.com/duel/participating

Get all predictions where the authenticated user is a participant, with optional filtering, sorting and pagination.
