...
**URL:** [https://xapi.duelduck.com/duel/my](https://xapi.duelduck.com/duel/my)

Retrieves a paginated list of predictions created by or assigned to the authenticated user. Supports advanced filtering, ordering, and pagination via query parameters.
...
List of predictions belonging to the authenticated user.
